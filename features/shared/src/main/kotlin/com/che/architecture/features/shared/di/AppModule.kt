...
object AppModule {
    ...
    fun getAppViewModel(): MviViewModel<AppState, AppIntentions, AppUiEvent> =
        DefaultViewModel(
    ...
    private fun getStateStore(): StateStore<AppState> =
        DefaultStateStore(AppState())

    private fun getProcessor(): Set<IntentionProcessor<AppState, AppIntentions>> =
        setOf(
            TabChangedIntentionProcessor(getEventDispatcher())
        )
}
