...
import com.che.architecture.atomic.design.resources.warning
...
fun WarningScreen(
    ...
    Column(
        ...
        Icon(
            imageVector = vectorResource(resource = Res.drawable.ic_warning),
            contentDescription = stringResource(resource = Res.string.warning)
        )
        Text(
