...
internal class MainActivity : ComponentActivity() {
    ...
    private lateinit var appViewModel: MviViewModel<AppState, AppIntentions, AppUiEvent>

    private lateinit var navigationGraphBuilders: Set<NavigationGraphBuilder>

    private val navigations: Set<NavigationGraphBuilder> by lazy {
        setOf(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationGraphBuilders = navigations

        tabNavigation = TabNavigation(navigationGraphBuilders)
    ...
    override fun onStart() {
        super.onStart()
        appViewModel.start(lifecycleScope)
    }
